...
declare global {
  ...
  const clearObject: typeof import('../src/utils/common-util')['clearObject']
  ...
  const enumToObjArr: typeof import('../src/utils/common-util')['enumToObjArr']
  ...
  const generateRoutersByMenus: typeof import('../src/hooks/use-permission')['generateRoutersByMenus']
  ...
  const httpGet: typeof import('../src/utils/axios-req')['httpGet']
  ...
  const menus: typeof import('../src/hooks/use-permission')['menus']
  ...
  const useInterval: typeof import('../src/hooks/use-interval')['useInterval']
